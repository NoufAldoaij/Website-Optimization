...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var randomPizzasSize = document.getElementById("randomPizzas").offsetWidth;
    var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");

    for (var i = 0; i <randomPizzaContainer.length; i++) {
      randomPizzaContainer[i].style.width = (sizeSwitcher(size) * randomPizzasSize) + 'px';
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var backgoundPizzas = Math.ceil(screen.height / s) * cols;

  for (var i = 0; i < backgoundPizzas; i++) {
